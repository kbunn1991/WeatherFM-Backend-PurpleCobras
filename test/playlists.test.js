...
describe('WeatherFM API - Playlists', function () {
    ...
    describe('PUT /api/users/playlists', function () {
        ...
        it('should add song to playlist', function () {
            const updateItem = { weather: 'Sunny', artist: 'prince', songTitle: 'purple rain', albumPng: 'blahblah' };
            let data;
            return User.findOne()
                .then(_data => {
                    data = _data;
    ...
    describe('DELETE /api/users/playlists', function () {
        ...
        it('should delete a song and return the new playlists', function () {
            const updateItem = { weather: 'Sunny', artist: 'Tevin', songTitle: 'I 2 I', albumPng: 'google.com' };
            let data;
            return User.findOne()
                .then(_data => {
                    data = _data;
